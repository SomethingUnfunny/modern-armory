...
public class MiArmoryItems {
	...
	public static final DeferredItem<ModularArmor> MODULAR_HELMET = ITEMS.register("modular_helmet", () -> new ModularArmor(ArmorItem.Type.HELMET));
	public static final DeferredItem<ModularArmor> MODULAR_CHESTPLATE = ITEMS.register("modular_chestplate", () -> new ModularArmor(ArmorItem.Type.CHESTPLATE));
	public static final DeferredItem<ModularArmor> MODULAR_LEGGINGS = ITEMS.register("modular_leggings", () -> new ModularArmor(ArmorItem.Type.LEGGINGS));
	public static final DeferredItem<ModularArmor> MODULAR_BOOTS = ITEMS.register("modular_boots", () -> new ModularArmor(ArmorItem.Type.BOOTS));
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATIVE_MODE_TAB = CREATIVE_MODE_TABS.register("mi_armory_tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.mi_armory")).withTabsBefore(CreativeModeTabs.COMBAT).icon(() -> DETONATOR.get().getDefaultInstance()).displayItems((parameters, output) -> {
		...
		output.accept(MODULAR_HELMET.asItem());
		output.accept(MODULAR_CHESTPLATE.asItem());
		output.accept(MODULAR_LEGGINGS.asItem());
		output.accept(MODULAR_BOOTS.asItem());
	}).build());
	...
	public static void onRegisterCapabilities(RegisterCapabilitiesEvent event) {
		ISimpleEnergyItem.registerStorage(event, MODULAR_HELMET.get());
		ISimpleEnergyItem.registerStorage(event, MODULAR_CHESTPLATE.get());
		ISimpleEnergyItem.registerStorage(event, MODULAR_LEGGINGS.get());
		ISimpleEnergyItem.registerStorage(event, MODULAR_BOOTS.get());
	}
}
